...
//
//     final pokemonSpeciesInfo = pokemonSpeciesInfoFromJson(jsonString);

import 'dart:convert';

PokemonSpeciesInfo pokemonSpeciesInfoFromJson(String str) => PokemonSpeciesInfo.fromJson(json.decode(str));

String pokemonSpeciesInfoToJson(PokemonSpeciesInfo data) => json.encode(data.toJson());
...
class PokemonSpeciesInfo {
    ...
    factory PokemonSpeciesInfo.fromJson(Map<String, dynamic> json) => PokemonSpeciesInfo(
